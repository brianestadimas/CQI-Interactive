...
function createScene(engine, canvas, config) {
  ...
  quantumPhaseDisk = new QuantumPhaseDisk(
    "quantumPhaseDisk",
    scene,
    blochSphere,
    groundPositionVertical
  );
  ...
  rightPanel.horizontalAlignment =
    BABYLON.GUI.Control.HORIZONTAL_ALIGNMENT_RIGHT;
  ...
  var addRadio = function (text, selected, parent, observable) {
    ...
    var header = BABYLON.GUI.Control.AddHeader(button, text, "80px", {
      isHorizontal: true,
      controlFirst: true,
    });
    header.height = "100px";
  ...
  var zeroStateBtn = CreateImageButton(
    "textures/zero-state.png",
    buttonSize,
    paddingTop,
    () => {
  ...
  var xGateBtn = CreateImageButton(
    "textures/x-gate.png",
    buttonSize,
    paddingTop,
    () => {
  ...
  var yGateBtn = CreateImageButton(
    "textures/y-gate.png",
    buttonSize,
    paddingTop,
    () => {
  ...
  var zGateBtn = CreateImageButton(
    "textures/z-gate.png",
    buttonSize,
    paddingTop,
    () => {
  ...
  var hGateBtn = CreateImageButton(
    "textures/h-gate.png",
    buttonSize,
    paddingTop,
    () => {
  ...
  var rxPi12GateBtn = CreateImageButton(
    "textures/rx+gate.png",
    buttonSize,
    paddingTop,
    () => {
  ...
  var ryPi12GateBtn = CreateImageButton(
    "textures/ry+gate.png",
    buttonSize,
    paddingTop,
    () => {
  ...
  var rzPi12GateBtn = CreateImageButton(
    "textures/rz+gate.png",
    buttonSize,
    paddingTop,
    () => {
  ...
  var oneStateBtn = CreateImageButton(
    "textures/one-state.png",
    buttonSize,
    paddingTop,
    () => {
  ...
  var sGateBtn = CreateImageButton(
    "textures/s-gate.png",
    buttonSize,
    paddingTop,
    () => {
  ...
  var sDagGateBtn = CreateImageButton(
    "textures/s-dag-gate.png",
    buttonSize,
    paddingTop,
    () => {
  ...
  var tGateBtn = CreateImageButton(
    "textures/t-gate.png",
    buttonSize,
    paddingTop,
    () => {
  ...
  var tDagGateBtn = CreateImageButton(
    "textures/t-dag-gate.png",
    buttonSize,
    paddingTop,
    () => {
  ...
  var rxmPi12GateBtn = CreateImageButton(
    "textures/rx-gate.png",
    buttonSize,
    paddingTop,
    () => {
  ...
  var rymPi12GateBtn = CreateImageButton(
    "textures/ry-gate.png",
    buttonSize,
    paddingTop,
    () => {
  ...
  var rzmPi12GateBtn = CreateImageButton(
    "textures/rz-gate.png",
    buttonSize,
    paddingTop,
    () => {
  ...
  qubitStateDiracImagePanel.horizontalAlignment =
    BABYLON.GUI.Control.HORIZONTAL_ALIGNMENT_CENTER;
  qubitStateDiracImagePanel.verticalAlignment =
  ...
  var qubitStateDiracImage = new BABYLON.GUI.Image(
    "but",
    "images/qubit-state-dirac.png"
  );
  ...
  qubitStateDiracTextPanel.horizontalAlignment =
    BABYLON.GUI.Control.HORIZONTAL_ALIGNMENT_CENTER;
  qubitStateDiracTextPanel.verticalAlignment =
    BABYLON.GUI.Control.VERTICAL_ALIGNMENT_TOP;
  ...
  quantumStateGrid.addColumnDefinition(0.7);
  quantumStateGrid.addColumnDefinition(0.1);
  quantumStateGrid.addColumnDefinition(0.3);
  quantumStateGrid.addRowDefinition(0.5);
  quantumStateGrid.addRowDefinition(0.5);
  ...
  statevectorInputText.horizontalAlignment =
    BABYLON.GUI.Control.HORIZONTAL_ALIGNMENT_LEFT;
  statevectorInputText.verticalAlignment =
    ...
    switch (pointerInfo.type) {
      case BABYLON.PointerEventTypes.POINTERDOWN:
        ...
        if (
          ...
          pointerInfo.pickInfo.pickedMesh == blochSphere.sphere
        ) {
...
function updateQuantumStateDisplay(config) {
  ...
  probAmplitudeTextBlock1.text =
    blochSphere.getProbAmplitude1().re.toFixed(2) +
    (imaginary1 < 0 ? " - " : " + ") +
  ...
  azimuthRadiansTextBlock.text = azimuthRadiansToPiRadians(
    blochSphere.getAzimuthRadians()
  );
  azimuthRadiansTextBlock.color = "black";
  azimuthRadiansTextBlock.fontSize = config.fontSize * 0.7;
  azimuthRadiansTextBlock.horizontalAlignment =
    BABYLON.GUI.Control.HORIZONTAL_ALIGNMENT_LEFT;
